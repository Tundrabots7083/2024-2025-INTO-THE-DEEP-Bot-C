...
@Autonomous (name = "Intake Specimen From Wall BT", group = "tests")
public class IntakeSpecimenFromWallBehaviorTreeTest extends LinearOpMode {

    IntakeBlueSpecimenBehaviorTree behaviorTree = null;
    ...
    private void initialize(){
        ...
        this.behaviorTree = new IntakeBlueSpecimenBehaviorTree(hardwareMap,telemetry);
