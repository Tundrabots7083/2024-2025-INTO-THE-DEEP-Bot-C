...
public class WristSpecimenIntakePosition implements ActionFunction  {
   // IntakeAndScoringSubsystem intakeAndScoringSubsystem;
    ...
    public WristSpecimenIntakePosition(Telemetry telemetry, Wrist wrist) {
        this.wrist = wrist;
