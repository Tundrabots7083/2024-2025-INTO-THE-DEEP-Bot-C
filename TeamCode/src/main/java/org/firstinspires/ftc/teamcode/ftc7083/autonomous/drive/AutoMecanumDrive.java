...
public class AutoMecanumDrive {
    ...
    public class DriveLocalizer implements org.firstinspires.ftc.teamcode.roadrunner.Localizer {
        ...
        public DriveLocalizer() {
            ...
            leftBack = new OverflowEncoder(new RawEncoder(mecanumDrive.leftRear));
            rightBack = new OverflowEncoder(new RawEncoder(mecanumDrive.rightRear));
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            mecanumDrive.leftFront.setPower(leftFrontPower);
            mecanumDrive.leftRear.setPower(leftBackPower);
            mecanumDrive.rightRear.setPower(rightBackPower);
            mecanumDrive.rightFront.setPower(rightFrontPower);
    ...
    public final class TurnAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            mecanumDrive.leftFront.setPower(feedforward.compute(wheelVels.leftFront) / voltage);
            mecanumDrive.leftRear.setPower(feedforward.compute(wheelVels.leftBack) / voltage);
            mecanumDrive.rightRear.setPower(feedforward.compute(wheelVels.rightBack) / voltage);
            mecanumDrive.rightFront.setPower(feedforward.compute(wheelVels.rightFront) / voltage);
    ...
    public TrajectoryActionBuilder actionBuilder(Pose2d beginPose) {
        return new TrajectoryActionBuilder(
                AutoMecanumDrive.TurnAction::new,
                AutoMecanumDrive.FollowTrajectoryAction::new,
