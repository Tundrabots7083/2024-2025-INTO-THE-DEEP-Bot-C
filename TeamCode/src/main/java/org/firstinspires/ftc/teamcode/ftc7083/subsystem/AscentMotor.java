...
public class AscentMotor extends SubsystemBase {
    ...
    public static double TICKS_PER_REV = 5455;
     ...
     */
    public AscentMotor(HardwareMap hardwareMap, Telemetry telemetry, FeedForward feedForward) {
    ...
    @Override
    public void execute() {
        currentLength = ascentMotor.getCurrentInches();
        double targetLength;
