 ...
 */
@Config
public class RedBasketSampleWithBT {
    ...
    public static double BASKET_HIGH_SPECIMEN_1_Y = -58.5;;
     ...
     */
    public RedBasketSampleWithBT(AutoMecanumDrive drive) {
     ...
     */
    public RedBasketSampleWithBT(AutoMecanumDrive drive, Pose2d initialPose) {
     ...
     */
    public RedBasketSampleWithBT(TrajectoryActionBuilder actionBuilder) {
