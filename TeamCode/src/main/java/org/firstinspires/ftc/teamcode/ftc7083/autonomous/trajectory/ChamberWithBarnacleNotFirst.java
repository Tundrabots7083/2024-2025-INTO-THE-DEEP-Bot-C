 ...
 */
@Config
public class ChamberWithBarnacleNotFirst {
     ...
     */
    public ChamberWithBarnacleNotFirst(AutoMecanumDrive drive) {
     ...
     */
    public ChamberWithBarnacleNotFirst(AutoMecanumDrive drive, Pose2d initialPose) {
     ...
     */
    public ChamberWithBarnacleNotFirst(TrajectoryActionBuilder actionBuilder) {
