 ...
 */
@Config
public class ChamberWithBarnacleFirst {
    ...
    public static double SPIKE_MARK_1_OBSERVATION_ZONE_Y = -42;
    public static double SPIKE_MARK_1_OBSERVATION_ZONE_ORIENTATION = -65;

    // Pickup specimen 2 from wall
    public static double SPECIMEN_2_INTAKE_AT_WALL_STAGE_1_Y = -44;
    ...
    public static double PARK_Y = -50;
     ...
     */
    public ChamberWithBarnacleFirst(AutoMecanumDrive drive) {
     ...
     */
    public ChamberWithBarnacleFirst(AutoMecanumDrive drive, Pose2d initialPose) {
     ...
     */
    public ChamberWithBarnacleFirst(TrajectoryActionBuilder actionBuilder) {
    ...
    public Action getTrajectory() {
        ...
        return actionBuilder
                ...
                */
                ...
                .strafeToSplineHeading(new Vector2d(SPIKE_MARK_1_OBSERVATION_ZONE_X,SPECIMEN_2_INTAKE_AT_WALL_STAGE_1_Y), Math.toRadians(SPECIMEN_2_INTAKE_AT_WALL_STAGE_1_ORIENTATION))
