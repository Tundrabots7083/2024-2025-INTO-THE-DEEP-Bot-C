...
import org.firstinspires.ftc.teamcode.ftc7083.behaviortree.BehaviorTreeComponents.ActionFunctions.ResetWristSubsystem;
import org.firstinspires.ftc.teamcode.ftc7083.behaviortree.BehaviorTreeComponents.ActionFunctions.TurnWrist;
import org.firstinspires.ftc.teamcode.ftc7083.behaviortree.BehaviorTreeComponents.ActionFunctions.TurnWristSubsystem;
...
public class WristOrientationBehaviorTreeSubsystem {
    ...
    public WristOrientationBehaviorTreeSubsystem(HardwareMap hardwareMap, Telemetry telemetry) {
    ...
    private void Init() {
        ...
        this.root = new Sequence(
                Arrays.asList(
                        new Action(new ResetWristSubsystem(telemetry,intakeAndScoringSubsystem),telemetry),
                        new Action(new DetectSampleOrientation(telemetry, globalShutterCamera),telemetry),
                        new Action(new TurnWristSubsystem(telemetry,intakeAndScoringSubsystem),telemetry)
                ),telemetry);
