...
public class Chamber {
    ...
    public static double SPECIMEN_1_CHAMBER_X = 0;
    ...
    public static double SPECIMEN_2_INTAKE_AT_WALL_STAGE_1_Y = -43.0;
    public static double SPECIMEN_2_INTAKE_AT_WALL_STAGE_1_ORIENTATION = -65;
    public static double SPECIMEN_2_INTAKE_AT_WALL_STAGE_2_Y = SPECIMEN_2_INTAKE_AT_WALL_STAGE_1_Y - 2.5;
    public static double SPECIMEN_2_INTAKE_AT_WALL_STAGE_2_ORIENTATION = -60;

    // Position for scoring specimen 2 on the high chamber
    public static double SPECIMEN_2_CHAMBER_X = SPECIMEN_1_CHAMBER_X;
    public static double SPECIMEN_2_CHAMBER_Y = -48;
    ...
    public static double SPECIMEN_3_INTAKE_AT_WALL_STAGE_1_ORIENTATION = -65;
    public static double SPECIMEN_3_INTAKE_AT_WALL_STAGE_2_Y = SPECIMEN_3_INTAKE_AT_WALL_STAGE_1_Y - 2.5;
    public static double SPECIMEN_3_INTAKE_AT_WALL_STAGE_2_ORIENTATION = -60;
...
//                .strafeTo(new Vector2d(SPECIMEN_3_INTAKE_AWAY_FROM_WALL_X, SPECIMEN_3_INTAKE_AWAY_FROM_WALL_Y))
//                .stopAndAdd(ias.actionMoveToIntakeSpecimenOffWallPosition())
//                .turn(Math.toRadians(SPECIMEN_3_INTAKE_AWAY_FROM_WALL_ORIENTATION))
//                .stopAndAdd(ias.actionMoveToIntakeSpecimenOffWallPosition())
