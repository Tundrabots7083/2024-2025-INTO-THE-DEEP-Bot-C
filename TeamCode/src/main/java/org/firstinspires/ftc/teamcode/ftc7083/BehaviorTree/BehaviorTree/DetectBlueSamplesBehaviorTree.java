...
public class DetectBlueSamplesBehaviorTree {
    ...
    public DetectBlueSamplesBehaviorTree(HardwareMap hardwareMap, Telemetry telemetry) {
    ...
    private void Init() {
        ...
        this.root = new Sequence(
                Arrays.asList(
                        new Action(new DetectBlueSamplesSimplied(telemetry, limelight),telemetry)
                ),telemetry);
