...
/**
 * A test OpMode that drives the robot to a detected specimen on the wall. The color of the
 * specimen to drive to is set based on <code>Robot.INTAKE_COLOR</code>. Tuning constants are in
 * <code>Robot.DriveTo</code>.
 */
@TeleOp(name = "Limelight Drive To Specimen", group = "tests")
public class LimelightDriveToSpecimenTest extends OpMode {
    private final ElapsedTime timer = new ElapsedTime(ElapsedTime.Resolution.MILLISECONDS);
    private Robot robot;
    private Action driveToSpecimen;
    ...
    public void init() {
        ...
        driveToSpecimen = robot.mecanumDrive.actionDriveToSpecimen(robot.limelight);
    ...
    public void loop() {
        ...
        driveToSpecimen.run(new TelemetryPacket());
