...
public class BlueBasketSample {
    ...
    public static double BASKET_HIGH_PRELOAD_X = -55.5;
    public static double BASKET_HIGH_PRELOAD_Y = -57.0;
    public static double BASKET_HIGH_PRELOAD_ORIENTATION = 65;

    // Intake positions for spike mark 1
    public static double YELLOW_SPIKE_MARK_1_X = -53.25;
    public static double YELLOW_SPIKE_MARK_1_Y = -49.5;
    public static double YELLOW_SPIKE_MARK_1_ORIENTATION = 110;

    // Position for scoring in the high basket
    public static double BASKET_HIGH_SPECIMEN_1_X = -59.0;
    public static double BASKET_HIGH_SPECIMEN_1_Y = -55.0;;
