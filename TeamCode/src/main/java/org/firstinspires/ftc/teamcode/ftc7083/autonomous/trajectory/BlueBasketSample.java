...
public class BlueBasketSample {
    ...
    public static double INITIAL_POSE_X = -RedBasketSample.INITIAL_POSE_X;
    public static double INITIAL_POSE_Y = -RedBasketSample.INITIAL_POSE_Y;
    public static double INITIAL_ORIENTATION = -RedBasketSample.INITIAL_ORIENTATION;

    // Intake positions for spike mark 1
    public static double YELLOW_SPIKE_MARK_1_X = -RedBasketSample.YELLOW_SPIKE_MARK_1_X;
    public static double YELLOW_SPIKE_MARK_1_Y = -RedBasketSample.YELLOW_SPIKE_MARK_1_Y;
    public static double YELLOW_SPIKE_MARK_1_ORIENTATION = -RedBasketSample.YELLOW_SPIKE_MARK_1_ORIENTATION;

    // Position for scoring in the high basket
    public static double BASKET_HIGH_PRELOAD_X = -RedBasketSample.BASKET_HIGH_PRELOAD_X;
    public static double BASKET_HIGH_PRELOAD_Y = -RedBasketSample.BASKET_HIGH_PRELOAD_Y;;
    public static double BASKET_HIGH_PRELOAD_ORIENTATION = -RedBasketSample.BASKET_HIGH_PRELOAD_ORIENTATION;

    // Position for scoring in the high basket
    public static double BASKET_HIGH_SPECIMEN_1_X = -RedBasketSample.BASKET_HIGH_SPECIMEN_1_X;
    public static double BASKET_HIGH_SPECIMEN_1_Y = -RedBasketSample.BASKET_HIGH_SPECIMEN_1_Y;;
    public static double BASKET_HIGH_SPECIMEN_1_ORIENTATION = -RedBasketSample.BASKET_HIGH_SPECIMEN_1_ORIENTATION;

    // Intake positions for spike mark 2
    public static double YELLOW_SPIKE_MARK_2_X = -RedBasketSample.YELLOW_SPIKE_MARK_2_X;
    public static double YELLOW_SPIKE_MARK_2_Y = -RedBasketSample.YELLOW_SPIKE_MARK_2_Y;
    public static double YELLOW_SPIKE_MARK_2_ORIENTATION = -RedBasketSample.YELLOW_SPIKE_MARK_2_ORIENTATION;

    // Position for scoring in the high basket
    public static double BASKET_HIGH_SPECIMEN_2_X = -RedBasketSample.BASKET_HIGH_SPECIMEN_2_X;
    public static double BASKET_HIGH_SPECIMEN_2_Y = -RedBasketSample.BASKET_HIGH_SPECIMEN_2_Y;;
    public static double BASKET_HIGH_SPECIMEN_2_ORIENTATION = -RedBasketSample.BASKET_HIGH_SPECIMEN_2_ORIENTATION;
     ...
     */
    public BlueBasketSample(AutoMecanumDrive drive) {
     ...
     */
    public BlueBasketSample(AutoMecanumDrive drive, Pose2d initialPose) {
     ...
     */
    public BlueBasketSample(TrajectoryActionBuilder actionBuilder) {
