...
import java.util.List;
    ...
    /**
     * The {@link ColorBlobLocatorProcessorEx} finds "blobs" of a user-specified color
     * in the image. You can restrict the search area to a specified Region
     * of Interest (ROI).
     */
    public abstract class ColorBlobLocatorProcessorEx  implements VisionProcessor
    {
        /**
         * Class supporting construction of a {@link ColorBlobLocatorProcessorEx}
         */
        public static class Builder
        {
            private ColorRangeEx colorRange;
            private ColorRangeEx additionalColorRange;
            private ContourMode contourMode;
            private ImageRegionEx imageRegion;
             ...
             * @return Builder object, to allow for method chaining
             */
            public Builder setTargetColorRange(ColorRangeEx colorRange)
            {
             ...
             * @return Builder object, to allow for method chaining
             */
            public Builder setTargetColorRangeEx(ColorRangeEx colorRange, ColorRangeEx additionalColorRange)
            {
                this.colorRange = colorRange;
                this.additionalColorRange = additionalColorRange;
                return this;
            }
             ...
             * @return Builder object, to allow for method chaining
             */
            public Builder setRoi(ImageRegionEx roi)
            {
            ...
            /**
             * Construct a {@link ColorBlobLocatorProcessorEx} object using previously
             * set parameters
             * @return a {@link ColorBlobLocatorProcessorEx} object which can be attached
             * to your {@link org.firstinspires.ftc.vision.VisionPortal}
             */
            public ColorBlobLocatorProcessorEx build() {
                if (colorRange == null) {
                ...
                if (additionalColorRange != null) {
                    return new ColorBlobLocatorProcessorImplEx(colorRange, additionalColorRange, imageRegion, contourMode, erodeSize, dilateSize, drawContours, blurSize, boundingBoxColor, roiColor, contourColor);
                } else {
                    return new ColorBlobLocatorProcessorImplEx(colorRange, imageRegion, contourMode, erodeSize, dilateSize, drawContours, blurSize, boundingBoxColor, roiColor, contourColor);
                }
            }
        }
